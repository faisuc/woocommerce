	...
	class WC_Admin_Assets {
		...
		public function admin_scripts() {
			...
			if ( $this->is_order_meta_box_screen( $screen_id ) ) {
				...
				wp_register_script( 'wc-admin-order-items-totals', WC()->plugin_url() . '/assets/js/admin/order-items-totals' . $suffix . '.js', array(), $version );
				wp_enqueue_script( 'wc-admin-order-meta-boxes', WC()->plugin_url() . '/assets/js/admin/meta-boxes-order' . $suffix . '.js', array( 'wc-admin-meta-boxes', 'wc-admin-order-items-totals', 'wc-backbone-modal', 'selectWoo', 'wc-clipboard' ), $version );
				wp_localize_script(
